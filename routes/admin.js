...
import {adminUploadVideo, 
    adminUploadPoster, 
    adminMostViewedMovies, 
    editContent, 
    deleteVideo} from "../api-controllers/admin/uploadContent.js";
...
router.patch('/admin-editVideo/:id', editContent);
router.patch('/admin-deleteVideo/:id', deleteVideo);
